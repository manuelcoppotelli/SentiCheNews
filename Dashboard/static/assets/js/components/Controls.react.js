...
var PlotlyGraph = React.createClass({
    ...
    componentDidMount: function() {
        ...
        if(this.props.bindHover) {
            jQuery('#'+this.props.id).bind('plotly_hover', function(event, data){
        ...
        if(this.props.bindClick) {
            jQuery('#'+this.props.id).bind('plotly_click', function(event, data) {
                data = that._filterEventData(data)
